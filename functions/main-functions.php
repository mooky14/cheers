<?php
    ...
    try{
        $db = new PDO('mysql:host='.$dbhost.';port=3306;dbname='.$dbname,$dbuser,$dbpswd,array(PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8', PDO::ATTR_ERRMODE => PDO::ERRMODE_WARNING));
